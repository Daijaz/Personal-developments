  ...
  <div class="row justify-content-md-center">
    <div class="col-md-12">
      ...
      <p>Registro de Alumnos</p>
        ...
        <a href="oferta.php">/Diligenciar Oferta</a>
        <a href="llamado.php">/Visualizar llamados</a>
        <hr class="mb-3">
    </div>
      ...
      <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <select class="form-select" name="section" id="section" required>
            ...
            <option value="A">Aparecer en boletín</option>
            <option value="B">Notificar oficina de Facultad</option>
            <option value="C">No mostrar información</option>
          </select>
        </div>
        <div class="mb-3">
          <label for="formFile" class="form-label">Currículum</label>
